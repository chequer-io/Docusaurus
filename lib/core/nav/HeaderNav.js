      ...
      <span>
        <li key="languages">
          <a id="languages-menu" href="#">
            {siteConfig.langTranslateImg ? (
              <span className={'langTranslateImg'}>
                <img src={siteConfig.langTranslateImg} />
              </span>
            ) : null}
            <span className={'currentLanguage'}>{currentLanguage}</span>
          </a>
...
class HeaderNav extends React.Component {
        ...
        <div className="headerWrapper wrapper">
          <header>
            <a
              ...
              href={`https://www.sqlgate.com/redirectWithLanguage?redirect=/&language=${
                this.props.language
              }`}>
              ...
              {siteConfig.headerIconMobile && (
                <img
                  className="logo-mobile"
                  src={this.props.baseUrl + siteConfig.headerIconMobile}
                  alt={siteConfig.title}
                />
              )}
  ...
  renderResponsiveNav() {
    ...
    */
    ...
    const headerRightLinks = this.props.config.headerRightLinks;
    ...
    return (
      <div>
        ...
        <ul className="nav-right">
          {headerRightLinks.map(this.makeLinks, this)}
        </ul>
      </div>
    );
  }
